...
BEGIN
	...
	USING (
		...
		, p.propertyHashKey, p.amenitiesChecksum, p.photosChecksum, p.ratesChecksum
		...
		, propertyHashKey, amenitiesChecksum, photosChecksum, ratesChecksum
		)
	...
	WHEN NOT MATCHED BY TARGET AND src.[action] = 'INSERT' THEN INSERT (propertyId, sourceId, runId, externalId, externalURL, [description], name, regionName, typeOfProperty, postcode, regionId, cityId
		...
		, src.propertyHashKey, src.amenitiesChecksum, src.photosChecksum, src.ratesChecksum
		)
