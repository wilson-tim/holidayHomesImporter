USE [holidayHomes]
GO
/****** Object:  StoredProcedure [dbo].[propertySearch]    Script Date: 20/02/2014 10:44:24 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
IF OBJECT_ID (N'dbo.propertySearch', N'P') IS NOT NULL
    DROP PROCEDURE [dbo].[propertySearch];
GO
