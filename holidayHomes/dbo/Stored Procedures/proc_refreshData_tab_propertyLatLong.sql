--------------------------------------------------------------------------------------------
--	2014-03-31 TW
--	dbo.proc_refreshData_tab_propertyLatLong
--  
--  refreshes table dbo.tab_propertyLatLong for new / changed / deleted geographic data
--		
-- History
--	2014-03-31 TW New
--------------------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[proc_refreshData_tab_propertyLatLong]
AS
BEGIN
